...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KC_LSPO, KC_NUBS, MT(MOD_LCTL, KC_Z),    MT(MOD_LGUI, KC_X),    MT(MOD_LALT, KC_C),    MT(MOD_LSFT|MOD_LALT,KC_V),   MT(MOD_LSFT|MOD_LALT,KC_V),   LCA_T(KC_N),   MT(MOD_LSFT|MOD_LALT,KC_M),    MT(MOD_RALT, KC_COMM), MT(MOD_RGUI, KC_DOT),  MT(MOD_RCTL, KC_SLSH),          KC_RO,   KC_RSPC,              KC_UP,               KC_P1,   KC_P2,   KC_P3,   KC_PEQL,    KC_EXEC, KC_PSTE,
    ...
    KC_TRNS,KC_MS_WH_LEFT,KC_MS_WH_DOWN,KC_MS_WH_UP,KC_MS_WH_RIGHT,KC_TRNS,KC_SPC,KC_MS_LEFT,KC_MS_DOWN, KC_MS_UP, KC_MS_RIGHT,KC_APP,      KC_TRNS,KC_TRNS,          KC_TRNS,         KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,    KC_TRNS,KC_TRNS,
    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     KC_TRNS,     KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     KC_TRNS,KC_TRNS,KC_TRNS,    KC_TRNS,     KC_TRNS,KC_TRNS,    KC_TRNS, KC_TRNS
    ),

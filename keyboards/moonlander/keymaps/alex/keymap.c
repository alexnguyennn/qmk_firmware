...
enum custom_keycodes { RGB_SLD = SAFE_RANGE, HSV_0_255_255, HSV_86_255_128, HSV_172_255_255, EASYMOTION };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        ...
        SC_LSPO,        CTL_T(KC_Z),   GUI_T(KC_X),   ALT_T(KC_C),   LSA_T(KC_V),    KC_B,                                           KC_N,           LSA_T(KC_M),    ALT_T(KC_COMMA),GUI_T(KC_DOT), CTL_T(KC_SLSH),SC_RSPC,
        LT(1,KC_EQUAL), KC_UNDERSCORE,    KC_KP_PLUS,KC_LBRC,        LT(1,KC_RBRC),       LALT_T(KC_APPLICATION),                                                                                                LCTL_T(KC_ESCAPE),LT(1,KC_BSLS),          C(KC_B),        S(KC_INSERT),    QK_CAPS_WORD_TOGGLE,    LCTL(LSFT(KC_F12)),
        LT(3,KC_SPACE), LT(1,KC_BSPC),EASYMOTION,                         EASYMOTION,        LT(1,KC_DELETE),LT(3,KC_ENTER)
    ),
    [1] = LAYOUT_moonlander(
        KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,
        QK_CAPS_WORD_TOGGLE, KC_EXLM,        KC_AT,          KC_LCBR,        KC_RCBR,        KC_UNDERSCORE, KC_KP_PLUS,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_7,           KC_8,           KC_9,           KC_ASTR,        KC_F12,
    ...
    [2] = LAYOUT_moonlander(
        ...
        MU_TOGG,         KC_TRANSPARENT, KC_MS_ACCEL1,   KC_MS_ACCEL2,   KC_MS_ACCEL0,   KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_MS_WH_LEFT, KC_MS_WH_DOWN,  KC_MS_WH_UP,    KC_MS_WH_RIGHT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_UP,       KC_MS_RIGHT,    KC_TRANSPARENT, KC_MEDIA_PLAY_PAUSE,

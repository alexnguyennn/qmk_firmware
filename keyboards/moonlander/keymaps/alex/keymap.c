...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_TAB,         KC_Q,           KC_W,           LCAG_T(KC_E),           MT(MOD_MEH, KC_R),LT(2,KC_T),     TG(1),                                          TG(1),          LT(2,KC_Y),     MT(MOD_MEH, KC_U),KC_I,           KC_O,           KC_P,           KC_BSLASH,      
  ...
  [2] = LAYOUT_moonlander(
    ...
    MU_TOG,         KC_TRANSPARENT, KC_MS_ACCEL0,   KC_MS_ACCEL2,   KC_MS_ACCEL1,   KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_MS_WH_LEFT, KC_MS_WH_DOWN,  KC_MS_WH_UP,    KC_MS_WH_RIGHT, KC_TRANSPARENT, KC_TRANSPARENT, 

...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSPO,        CTL_T(KC_Z),  GUI_T(KC_X),   ALT_T(KC_C),   MT(MOD_LSFT|MOD_LALT,KC_V),   LCA_T(KC_B),   C(KC_B),
        LT(SYMB,KC_EQUAL), KC_UNDERSCORE,      EASYMOTION,  KC_LBRACKET, TD(SYMB_TAP_RBRK),
         ...
         // right hand
             ...
             C(KC_B),LCA_T(KC_N),   MT(MOD_RSFT|MOD_RALT,KC_M),  RALT_T(KC_COMM),RGUI_T(KC_DOT), CTL_T(KC_SLSH),   KC_RSPC,

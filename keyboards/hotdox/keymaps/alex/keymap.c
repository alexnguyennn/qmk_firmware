...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_TAB,        LCAG_T(KC_Q),         MEH_T(KC_W),   ALL_T(KC_E),   KC_R,   KC_T,   TG(SYMB),
        HYPR_T(KC_ESCAPE),        MT(MOD_LCTL|MOD_LGUI,KC_A),         MT(MOD_LALT|MOD_LGUI,KC_S),   SGUI(KC_D),   C_S_T(KC_F),   LCA_T(KC_G),
        ...
        LT(SYMB,KC_EQUAL),KC_QUOT,      LALT(KC_LSFT),  KC_LEFT,KC_RGHT,
         ...
         // right hand
             ...
             TG(SYMB),    KC_Y,   KC_U,  ALL_T(KC_I),   MEH_T(KC_O),   LCAG_T(KC_P),             KC_BSLS,
                          LCA_T(KC_H),   C_S_T(KC_J),  SGUI(KC_K),   MT(MOD_LALT|MOD_LGUI,KC_L),   MT(MOD_LCTL|MOD_LGUI,KC_SCLN),GUI_T(KC_QUOT),
             ...
             KC_PGUP,
             KC_PGDN,LT(SYMB,KC_DELETE),LT(MDIA,KC_ENT)
    ),
